...
import {
  ...
  CpuChipIcon as FilledCpuChipIcon,
  ExclamationTriangleIcon as FilledExclamationTriangleIcon,
  FilmIcon as FilledFilmIcon,
  RectangleGroupIcon as FilledRectangleGroupIcon,
...
const MobileMenu = () => {
  ...
  const menuLinks: MenuLink[] = [
    ...
    {
      href: '/ai',
      content: intl.formatMessage(menuMessages.ai),
      svgIcon: <CpuChipIcon className="h-6 w-6" />,
      svgIconSelected: <FilledCpuChipIcon className="h-6 w-6" />,
      activeRegExp: /^\/ai$/,
    },
    {
    ...
    {
      href: '/operations',
      content: intl.formatMessage(menuMessages.operations),
      svgIcon: <RectangleGroupIcon className="h-6 w-6" />,
      svgIconSelected: <FilledRectangleGroupIcon className="h-6 w-6" />,
